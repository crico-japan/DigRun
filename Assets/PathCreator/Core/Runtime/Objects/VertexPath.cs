...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public const float MIN_VERTEX_SPACING = .01f;
        ...
        public VertexPath (BezierPath bezierPath, Transform transform, float vertexSpacing):
            this (bezierPath, VertexPathUtility.SplitBezierPathEvenly (bezierPath, Mathf.Max (vertexSpacing, MIN_VERTEX_SPACING), VertexPath.ACCURACY), transform) { }
